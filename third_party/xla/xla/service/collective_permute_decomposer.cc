...
// Contains a collective permute operation and send and recv operations it was
// decomposed to.
...
// execute recv with no devices executing send.
// The input argument is a vector of decomposed collective permutes in order
...
absl::Status EnforceOrderOfSendRecvChains(
  ...
  // Order the decomposed permutes in order of scheduling preference - the first
  // ones in the array should come earlier.
  // Two criteria in order of importance:
