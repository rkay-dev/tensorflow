...
struct RewriteMaterialize : mlir::OpRewritePattern<MaterializeOp> {
  ...
  mlir::LogicalResult matchAndRewrite(
    ...
    ImplicitLocOpBuilder b(op.getLoc(), rewriter);
    auto i0 =
        b.create<mlir::arith::ConstantOp>(b.getIndexType(), b.getIndexAttr(0));
    auto i1 =
        b.create<mlir::arith::ConstantOp>(b.getIndexType(), b.getIndexAttr(1));
    ...
    auto loop = b.create<LoopOp>(
        ...
        [&](OpBuilder&, Location, ValueRange ivs, ValueRange map_results,
          ...
          Value new_vec;
          if (auto complex =
                  mlir::dyn_cast<mlir::ComplexType>(call_result.getType())) {
